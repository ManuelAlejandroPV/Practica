...
event.respondWith(null);
        ...
        if(event.request.url.includes('.png')){
           // console.log(event.request.url);
            //let fotoUrl = fetch(event.request.utl);
            //console.log(fotoUrl);
            let fotoUrl = fetch('view/img/slider-bg.png');
            event.respondWith(fotoUrl);
        }
...
if(event.request.url.includes('style.css')){
   ...
   let respuesta = new Response(
        `html, body, div, span, applet, object, iframe, h1, h2, h3, h4, h5, h6, p, blockquote, pre, a, abbr, acronym, address, big, cite, code, del, dfn, em, img, ins, kbd, q, s, samp, small, strike, strong, sub, sup, tt, var, b, u, i, center, dl, dt, dd, ol, ul, li, fieldset, form, label, legend, table, caption, tbody, tfoot, thead, tr, th, td, article, aside, canvas, details, embed, figure, figcaption, footer, header, hgroup, menu, nav, output, ruby, section, summary, time, mark, audio, video {
          ...
          body {
            font-family: "Open Sans", Monaco, sans-serif;
            font-size: .83em;
            line-height: 1.75;
            color: blue;
...
if(event.request.url.includes('view/images/cuatro.jpg')){
    let fotoUrl = fetch('view/images/SIN.jpg')
